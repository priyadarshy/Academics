...
for j=26:length(z_pts)                       % Loop over field locations
...
figure(1)
hold on
plot(x_pts,field_db(26,:),'k');
xlabel('x');
ylabel('Field Strength dB');
title('Half-Wavelength Spacing - Field at z = 50 mm');
axis([-0.01 0.01 -40 0])


UltrasoundHomework_Task2(1);
legend('Half-Wavelength', 'No Window', 'Hann Window')
